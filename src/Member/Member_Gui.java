...
public class Member_Gui extends JFrame implements ActionListener, MouseListener {
	...
	public void addLabel() {
		...
		for (Entry<String, JLabel> entrySet : badm.getLabelMap().entrySet()) {
			String labelkey = entrySet.getKey(); 
			mainP_west.add(entrySet.getValue());
			System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
			for (Entry<String, JButton> entrySet2 : badm.getButtonMap().entrySet())	{
				
				if(labelkey.equals(entrySet2.getKey()))	{
					System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
					this.key1=entrySet2.getKey();
					this.bt1=entrySet2.getValue();
				...
				if(labelkey.equals(entrySet2.getKey()))	{
					System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
					this.key2=entrySet2.getKey();
					this.bt2=entrySet2.getValue();
				...
				if(labelkey.equals(entrySet2.getKey()))	{
					System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
					this.key3=entrySet2.getKey();
					this.bt3=entrySet2.getValue();
				...
				if(labelkey.equals(entrySet2.getKey()))	{
					System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
					this.key4=entrySet2.getKey();
					this.bt4=entrySet2.getValue();
				...
				if(labelkey.equals(entrySet2.getKey()))	{
					System.out.println(entrySet.getKey()+"라벨에 접속하는 키");
					this.key5=entrySet2.getKey();
					this.bt5=entrySet2.getValue();
...
//			System.out.println(entrySet.getKey()+"버튼에 접속하는키");
...
//					
//				}
//				if(btcnt==1 && entrySet.getKey().equals(k))	{
//					this.key1=k;
//					this.bt1=a;
//					bt1.addActionListener(this);
...
//				}
//				if(btcnt==2 && entrySet.getKey().equals(k))	{
//					this.key2=k;
//					this.bt2=a;
//					bt2.addActionListener(this);
...
//					System.out.println("성공");
//				}
//				if(btcnt==3 && entrySet.getKey().equals(k))	{
//					this.key3=k;
//					this.bt3=a;
//					bt3.addActionListener(this);
...
//					System.out.println("성공");
//				}
//				if(btcnt==4 && entrySet.getKey().equals(k))	{
//					this.key4=k;
//					this.bt4=a;
//					bt4.addActionListener(this);
...
//					System.out.println("성공");
//				}
//				if(btcnt==5 && entrySet.getKey().equals(k))	{
//					this.key5=k;
//					this.bt5=a;
//					bt5.addActionListener(this);
